          ...
          <div className="column is-one-fifth">
            ...
            >
              ...
              <ul className="menu-list">
                <li>
                  <NavLink to={"/"} exact isActive={"is-active"}>
                    Strona główna
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/recipes"} exact isActive={"is-active"}>
                    Przepisy
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/products"} exact isActive={"is-active"}>
                    Produkty
                  </NavLink>
                </li>
              </ul>
              ...
              <ul className="menu-list">
                <li>
                  <NavLink to={"/recipes/add"} isActive={"is-active"}>
                    Dodaj Przepis
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/products/add"} isActive={"is-active"}>
                    Dodaj Produkt
                  </NavLink>
                </li>
              </ul>
